...
type UserInfo struct {
	...
	Telephone     string         `gorm:"column:telephone;index;not null;type:char(11);comment:手机号"`
	...
	LastOnlineAt  sql.NullTime   `gorm:"column:last_online_at;type:datetime;comment:最近登录时间"`
	...
	Status        int8           `gorm:"ciolumn:status;index;not null;comment:用户状态：0.正常，1.禁用"`
}

func (UserInfo) TableName() string { // UserInfo 是方法的接收者
	return "user_info"
}
